...
def test_robot_quadrant_1() -> None:
    ...
    robot_points.add_point(-25.435345, -54.596969)
    ...
    for r_point in robot_points.get_points():
        ...
        plot(points, robot=r_point, closest_point=closest_point, correction_point=correction_point, correction_direction=correction_direction)
